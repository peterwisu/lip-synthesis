...
main_parser.add_argument('--result_dir', type=str, help="Directory to save result", default="./eval_vdo/Lrs3_adversarial")
main_parser.add_argument('--generator_checkpoint', type=str, help="File path for Generator model checkpoint weights" ,default='/home/peter/Peter/audio-visual/fyp/checkpoints/generator/adversarial_generator.pth')
