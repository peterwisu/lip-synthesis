...
main_parser.add_argument('--filelist', type=str, help="File path for filelist", default="./test_filelists/lrs2.txt")
main_parser.add_argument('--data_root', type=str,default='/media/peter/peterwish/dataset/lrs2_v1/mvlrs_v1/main/')
main_parser.add_argument('--model_type', type=str, default='lstm')
main_parser.add_argument('--result_dir', type=str, help="Directory to save result", default="./eval_vdo/pretrain003_l1_loss_lrs2/")
main_parser.add_argument('--generator_checkpoint', type=str, help="File path for Generator model checkpoint weights" ,default='../checkpoints/generator/pretrain003_l1_loss.pth')
